...
class CategorieModelTest(TestCase):
    ...
    def test_creation_categorie(self):
        ...
        self.assertEqual(cat.nom, "Téléphones")  # slugify retire les accents
...
class ProduitManagerTest(TestCase):
    ...
    def test_manager_actifs_exclut_inactif(self):
        ...
        p_inactif = creer_produit(
            self.vendeur, self.categorie, nom="Inactif", statut="inactif"
        )
    ...
    def test_manager_actifs_exclut_archive(self):
        ...
        p_archive = creer_produit(
            self.vendeur, self.categorie, nom="Archivé", statut="archive"
        )
    ...
    def test_manager_vedette(self):
        ...
        p_non_vedette = creer_produit(
            self.vendeur, self.categorie, nom="Non vedette", en_vedette=False
        )
    ...
    def test_manager_stock_bas(self):
        ...
        p_ok = creer_produit(
            self.vendeur, self.categorie, nom="Stock OK", stock=20, stock_minimum=5
        )
...
class ProduitAPITest(APITestCase):
    ...
    def test_filtre_prix_min(self):
        ...
        creer_produit(
            self.vendeur, self.categorie, nom="Cher", prix=Decimal("500000.00")
        )
    ...
    def test_filtre_prix_max(self):
        ...
        creer_produit(
            self.vendeur, self.categorie, nom="Très Cher", prix=Decimal("999999.00")
        )
    ...
    def test_filtre_en_stock(self):
        ...
        creer_produit(
            self.vendeur, self.categorie, nom="Épuisé", stock=0, statut="epuise"
        )
    ...
    def test_filtre_categorie_slug(self):
        ...
        response = self.client.get(
            self.url_liste, {"categorie_slug": self.categorie.slug}
        )
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_tri_par_prix(self):
        ...
        creer_produit(
            self.vendeur, self.categorie, nom="Peu Cher", prix=Decimal("10000.00")
        )
