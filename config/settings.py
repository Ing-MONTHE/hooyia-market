...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "apps.products.context_processors.categories_navbar",
...
DEFAULT_FROM_EMAIL = config(
    "DEFAULT_FROM_EMAIL",
    default=f'HooYia Market <{config("EMAIL_HOST_USER", default="")}>',
)
ADMIN_EMAIL = config(
    "ADMIN_EMAIL", default=config("EMAIL_HOST_USER", default="")
)  # Email qui reçoit les alertes remboursement
...
GOOGLE_REDIRECT_URI = config(
    "GOOGLE_REDIRECT_URI", default="https://hooyiamarket.site/compte/google/callback/"
)
...
)  # True en dev pour exécuter sans worker
